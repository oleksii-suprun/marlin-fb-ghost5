...
#define STRING_CONFIG_H_AUTHOR "(Oleksii Suprun, FlyingBear Ghost 5)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_ROBIN_NANO_V1_1
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  10.74
    #define DEFAULT_Ki   0.71
    #define DEFAULT_Kd  40.5
  #endif
#endif
